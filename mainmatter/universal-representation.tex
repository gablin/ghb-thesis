...
%
This is such values will typically always require the \gls{SIMD.i}
\gls{instruction} to be preceded by a copy \gls{instruction}, thereby
nullifying the benefit of the \gls{SIMD.i} \gls{instruction}.
