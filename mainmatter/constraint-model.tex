...
\begin{figure}
  ...
  \caption[%
          ...
          {%
            Normalized solving times for two constraint models that supports
...
%
We see clearly that the \glsplshort{constraint model} based on
...
\begin{figure}
  ...
  \caption[%
            Plot comparing optimal costs for two constraint models with and
            without value reuse%
          ]%
          {%
            Normalized optimal costs for two constraint models, one with value
...
%
We see clearly that \glsplshort{constraint model} supporting \gls{value reuse}
...
\begin{figure}
  ...
  \caption[%
          ...
          {%
            Normalized solving times for two constraint models that supports
            jump insertion, one based on branch extension (baseline) and another
...
\begin{figure}
  ...
  \caption[%
            Plot comparing optimal costs for two constraint models supporing
            jump instruction insertion%
          ]%
          {%
            Normalized optimal costs for two constraint models that supports
            jump insertion, one based on branch extension (baseline) and another
            based on DTB patterns%
          }
...
%
We see clearly that the \glsplshort{constraint model} based on \glspl{DTB
  pattern} yield significantly lower solving times than those based on
