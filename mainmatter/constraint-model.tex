...
\refAppendix{minizinc-implementation}.
...
%
Every \gls{CI} is computed with a predefined degree of confidence, say $X$,
typically written as the $X$\textsuperscript{th} \gls{CI}.
%
...
\subsubsection{Match Duplication \versus Alternative Values}
