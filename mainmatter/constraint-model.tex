...
another \glsshort{constraint model} based on \glspl{alternative value}
%
...
produced by two versions of the \gls{constraint model}: one based on \gls{branch
  extension}, and another based on \glspl{DTB pattern}.
