...
\gls!{geometric mean improvement}.
...
%
Hence the \gls{geometric mean improvement} should be greater than~\num{1}.
...
}, thus defending our claim that \glsplshort{constraint model} based on
...
}, thus defending our claim that \glsplshort{constraint model} supporting
...
%
Hence the \gls{geometric mean improvement} for both should be greater
than~\num{1}.
...
%
The \gls{geometric mean improvement} for solving time is \num{%
...
%
In addition, the \gls{geometric mean improvement} for cost is \num{%
  \DualTargetPatternsVsBranchExtCyclesSpeedupCyclesRegularSpeedupGmean%
}, thus defending our claim that, in some cases, \glspl{DTB pattern} result in
optimal \glspl{solution} with slightly lower cost compared with \gls{branch
  extension}.
%
