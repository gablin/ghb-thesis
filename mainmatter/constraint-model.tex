...
%
In one case (\codeInText{reg2rsaref}), for example, the solving time differs by
...
%
In one case (\codeInText{putseqdispext}), for example, where two constants are
...
\codeInText{nextkeypacket} -- the \gls{search space} for \glsshort{constraint
