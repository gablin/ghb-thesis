...
As the \gls{GMI} is \printGMI{%
  ...
  \DualTargetPatternsVsBranchExtCyclesSpeedupCyclesRegularSpeedupCiMin%
    ...
    \DualTargetPatternsVsBranchExtCyclesSpeedupCyclesRegularSpeedupCiMax%
}, we see that, in some cases, \glsshort{constraint
  model}~\refModel{dual-target} produces optimal \glspl{solution} with slightly
lower cost compared those produced by \glsshort{constraint
  model}~\refModel{branch-ext}.
%
