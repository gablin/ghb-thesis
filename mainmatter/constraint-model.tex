...
%
In such cases, we compute the \SI{95}{\%} \gls{CI} for the \gls{GMI} using the
bootstrapping resampling method with \num{10000} iterations.
%
If the confidence interval contains~\num{1}, then we cannot statistically
conclude whether the result is positive or negative.
...
%
The \gls{GMI} for solving time is \printGMI{%
...
%
In addition, the \gls{GMI} for cost is \printGMI{%
