...
approach that, for the first time, integrates \gls{global.is} \gls{instruction
...
%
These solving techniques are therefore crucial for scalability, enabling the
...
\gls{SIMD.i} \glspl{instruction} without having to resort to \gls{loop
  unrolling}
%
Moreover, this exploitation is benefited by \gls{global code motion}.
