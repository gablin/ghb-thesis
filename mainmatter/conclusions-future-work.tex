...
In this dissertation, I have introduced \gls!{universal instruction
  selection},\!%
%
\footnote{%
...
To handle the combinatorial nature of these problems, I have based the approach
on \glsdesc{CP}.
%
I have formulated a novel combinatorial model that is simpler and more flexible
...
%
I have also proposed extensions to the \glsshort{constraint model} for
integrating \gls{instruction scheduling} and \gls{register allocation}, which
are two other important tasks of \gls{code generation}.
...
To make the approach work in practice, I have introduced numerous solving
techniques.
%
Through experimental evaluation, I have shown that these techniques collectively
improve solving time up to \printSpeedup{%
...
%
I have also discovered that two solving techniques
...
I have experimentally evaluated my approach by comparing the code quality it
...
I have also performed experiments to evaluate the impact of \gls{SIMD.i}
...
With these results, I argue that \glsdesc{CP} is a flexible, practical,
