...
\begin{definition}[$\mAllDifferent$]
  ...
  \begin{displaymath}
    ...
    \mSetBuilder*{\langle d_1, \ldots, d_k \rangle}%
                 {
                   \begin{array}{@{}l@{\,}}
                     \forall 1 \leq i \leq k: d_i \in \mDomain(\mVar{x}_i), \\
                     \forall 1 \leq i < j \leq k: d_i \neq d_j
                   \end{array}
                 }\!.
  \end{displaymath}
    ...
    \mSetBuilder*{\mTuple{d_1, \ldots, d_k, e}}%
                 {
                   \begin{array}{@{}l@{\,}}
                     ...
                     e \in \mDomain(\mVar{y}), \\
                     e = \big|
                           \mSetBuilder{d_j}{\forall 1 \leq j \leq k : d_j = v}
                         \big|
                   \end{array}
                 }\!.
  \end{displaymath}
                   ...
                   }%
                   {
                     \begin{array}{@{}l@{}}
                       \forall 1 \leq i \leq k:
                         d_{\mVar{s}_i} \in \mDomain(\mVar{s}_i),
                         d_{\mVar{s}_i} \in \mDomain(\mVar{s}_i), \\
                       \forall 1 \,\leq\,
                               t \,<\, \mMax(\cup_i \mDomain(\mVar{s}_i)) :
                         \displaystyle
                         \hspace{-1.2em}
                         \sum_{%
                                \substack{
                                  1 \,\leq\, j \,\leq\, k, \\
                                  d_{\mVar{s}_j} \,\leq\, t \,<\,
                                  d_{\mVar{s}_j} \hspace{-.8pt}+\, l_j
                                }
                              }
                         \hspace{-1.2em}
                         d_{\mVar{b}_j} \times u_j
                         \leq c
                     \end{array}
                   }\!.
    \end{array}
    ...
    \begin{array}{c}
      ...
      \mSetBuilder*{%
                   ...
                   }%
                   {
                     \begin{array}{@{}l@{}}
                       \forall 1 \leq i \leq k :
                         d_{\mVar{xl}_i} \in \mDomain(\mVar{xl}_i),
                         d_{\mVar{xr}_i} \in \mDomain(\mVar{xr}_i),
                       \\
                       d_{\mVar{yl}_i} \in \mDomain(\mVar{yl}_i),
                       d_{\mVar{yu}_i} \in \mDomain(\mVar{yu}_i), \\
                       \begin{array}{@{}r@{\:}l@{}}
                           \forall i < j \leq k :
                         & d_{\mVar{xr}_i} \leq d_{\mVar{xl}_j} \mOr
                           d_{\mVar{xl}_i} \geq d_{\mVar{xr}_j} \mOr \mbox{} \\
                         & d_{\mVar{yu}_i} \leq d_{\mVar{yl}_j} \mOr
                           d_{\mVar{yl}_i} \geq d_{\mVar{yu}_j}
                       \end{array}
                     \end{array}
                   }\!.
    \end{array}
...
As will be seen in \refChapter{future-work}, $\mNoOverlap$ is used to integrate
