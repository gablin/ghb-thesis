...
\subsubsection{Instruction Selection as a Graph Problem}
...
linear time.
%
Consequently, such approaches typically apply generic \glshyphened{subgraph
...
%
Due to its simplicity, most combinatorial approaches apply the \gls{VF2}
algorithm~\cite{CordellaEtAl:2001}, of which a detailed description is given in
\refChapter{universal-representation}.


\subsection{Greedy Approaches}

We begin with discussing the greedy approaches to \gls{DAG covering}.
...
perform greedy \gls{pattern selection} on \glspl{function graph}.
%
