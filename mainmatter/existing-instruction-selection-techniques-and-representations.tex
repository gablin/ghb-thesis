...
\begin{figure}
  ...
  \caption[Example of a macro]%
          {%
            ...
            %
            The template to match is given as argument to \codeInText{expand},
            and the procedure to run upon expansion is given as
            \codeInText{expand}'s body%
          }
    ...
    \begin{array}{rl}
      \text{minimize}
        & \displaystyle
          ...
          \sum_{\mathclap{1 \leq i \leq n}} \mVector{c}_i^{\transp} \mVar{x}_i, \\
      \text{subject to}
        & \forall 1 \leq i \leq n :
          \mVector{1}^{\transp} \mVar{x}_i = 1. \\
    \end{array}
  \end{displaymath}
\end{definition}
