...
information to optimally reduce the \gls{expression tree} rooted at~$n$ to any
\gls{nonterminal}.
%
...
\gls{nonterminal}~$\mNT{N}$, then $\mNT{N}$ can be shared between the
\glspl{rule} whose \glsplshort{rule pattern} all contain $\mNT{N}$.
%
