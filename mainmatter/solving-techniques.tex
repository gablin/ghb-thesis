...
\mbox{$\mCost(m, o) \times \mFreq(b) = \sum_{o \,\in\, \mCovers(m)}
  \mCost(m \hspace{-.8pt}, o \hspace{-1pt}, b)$}.
...
cost incurred by covering \gls{operation}~$o$\hspace{-1pt}.
%
...
For each \gls{operation}~$o$\hspace{-1pt}, the combination
