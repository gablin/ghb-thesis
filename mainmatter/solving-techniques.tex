...
\begin{figure}
  ...
  \caption[%
          ...
          {%
            ...
            constraint models: one with no implied constraints (baseline) and
...
\def\mkFigureCaption{%
  \caption[%
          ...
          {%
            Normalized solving times (incl.\ presolving time) for two
            constraint models: one without a particular implied constraint
            (baseline) and another with the constraint (subject)%
          }
}
...
\begin{figure}
  ...
  \caption[%
          ...
          {%
            ...
            models: one with all implied constraints (baseline) and another
            without the constraints who individually have a negative effect on
...
another without the \glspl{constraint} who individually have a negative effect
on solving time, serving as \gls{subject}.
%
The solving times range from
\SIMinOf{
...
\begin{table}
  ...
  \caption[%
            Geometric mean improvements on solving time attained by a particular
            symmetry or dominance breaking constraint%
          ]%
          {%
            GMIs on the solving time attained by a particular symmetry or
...
\begin{table}
  ...
  \caption[%
          ...
          {%
            GMIs on the solving time attained by a particular presolving
            technique%
          }
