...
%
Hence, in this case the \gls{geometric mean improvement} should be greater
than~\num{1}.
%
...
%
Since the geometric mean speedup is \num{%
...
overall reduction in solving time -- hence the \gls{geometric mean improvement}
...
%
Hence, in these cases the \gls{geometric mean improvement} should be equal
to~\num{1}.
%
For the rest, we expect some \glspl{constraint} to lead to an overall reduction
in solving time -- hence the \gls{geometric mean improvement} should be greater
than~\num{1} -- while others may degrade solving time -- hence the
\gls{geometric mean improvement} should be less than~\num{1}.
%
...
%
The \gls{geometric mean improvement} is \num{%
...
\begin{table}
  ...
  \begin{tabular}{p{8mm}*{14}{@{\colsep}c@{\colsep}}}
    ...
    \midrule
        \tabhead GMI
      & \num{\SolvTechDisableImplConsDefsDominateDefsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsDefsInSpannedBlocksPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsIdenticalEntryBlocksPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsDefsDominateEntryBlocksPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsPlacePhiOpsSameAsDefEdgesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsNoSpanUsesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsNoSpanDefsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsNoSpanUseDefsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsSpannedInputPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsUsedDataMustBeAvailablePrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsExteriorDataMustBeAvailablePrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsLocsOfUsesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsLocsOfDefsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsFixFallThroughsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean} \\
    \bottomrule
  \end{tabular}

  \caption[%
            Geometric mean improvement on solving time attained by a given
            implied constraint%
          ]%
          {%
            Geometric mean improvement (GMI) on the solving time attained by a
            given implied constraint.
            %
...
\end{table}
%
The \glspl{geometric mean improvement}, given in
...
\begin{table}
  ...
  \begin{tabular}{p{8mm}*{6}{@{\colsep}c@{\colsep}}}
    ...
    \midrule
        \tabhead GMI
      & \num{\SolvTechDisableDomConsLocsOfStatesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableDomConsOperandsOfNonSelectedMatchesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableImplConsInputOperandsNotTakingMinValuePrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableDomConsInterchDataChainsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableDomConsNullCopyMatchSelectionPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableDomConsKillMatchSelectionPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean} \\
    \bottomrule
  \end{tabular}
  ...
  \caption[%
          ...
          {%
            Geometric mean improvement (GMI) on the solving time attained by a
            given symmetry or dominance breaking constraint.
            %
...
\begin{table}
  ...
  \begin{tabular}{p{8mm}*{9}{@{\colsep}c@{\colsep}}}
    ...
    \midrule
        \tabhead GMI
      & \num{\SolvTechDisableDomMatchesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableIllegalMatchesUncoveredOpsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableIllegalMatchesUndefinedDataPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableIllegalMatchesKillsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableIllegalMatchesDefLocsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableIllegalMatchesUseLocsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableRedunKillsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableRedunNonNullCopyMatchesPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean}
      & \num{\SolvTechDisableCanonicalLocsPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupGmean} \\
    \bottomrule
  \end{tabular}
