...
}, we conclude that \glsplshort{constraint model} with the \gls{implied.c}
\glspl{constraint} yield significantly lower solving times than those without
such \glspl{constraint}.
...
\refTable{single-impl-con-vs-no-con-solving-time-geom-mean-improvements}, we
conclude that Eqs.\thinspace\refEquation*{impl-cons-defs-in-spanned-blocks} and
