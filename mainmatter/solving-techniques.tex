...
\todo{this is the same as naive, sketch proof}
...
\begin{equation}
  \begin{array}{@{}c@{}}
    ...
    \mTable(
      \mTuple{b \hspace{-.8pt}, \mVar{dplace}[d]} \hspace{-1pt},
      \mDomMatrix
    ).
  \end{array}
...
\glspl{match} \glsshort{use.d}[ing] of $d$, then $m$ is \gls{illegal.m}.
%
This set of \gls{illegal.m} \glspl{match} is computed as
%
\begin{equation}
...
\todo{discuss why some techniques lead to degradation}
