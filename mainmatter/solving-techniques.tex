...
by four versions of the \glsshort{constraint model}: one with no \gls{implied.c}
...
Second, based on the results for the experiment above, we then evaluate synergy
effects among these \glspl{constraint} by comparing the solving times exhibited
by four versions of the \glsshort{constraint model}: one with no
...
versions of the \glsshort{constraint model}: one with no \gls{presolving}
