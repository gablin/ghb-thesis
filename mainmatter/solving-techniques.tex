...
\begin{equation}
  ...
  \end{array}
  \labelEquation{impl-cons-place-ops-same-as-entry-blocks}
\end{equation}
...
\begin{equation}
  ...
  \end{array}
  \labelEquation{impl-cons-place-phi-ops-same-as-def-edge}
\end{equation}
%
...
\begin{equation}
  \begin{array}{c}
    ...
    \text{\st } p_1 < p_2.
  \end{array}
  \labelEquation{impl-cons-spanning-uses}
\end{equation}
...
\begin{equation}
  ...
  \end{array}
  \labelEquation{impl-cons-constrain-use-locs}
\end{equation}
...
\begin{equation}
  \begin{array}{c}
    ...
    S \neq \mEmptySet.
  \end{array}
  \labelEquation{impl-cons-constrain-def-locs}
\end{equation}
...
\begin{equation}
  ...
  \end{array}
  \labelEquation{impl-cons-fix-fall-through}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{dom-cons-loc-of-states}
\end{equation}
%
...
\begin{equation}
  \begin{array}{c}
    ...
    \mCard{\mDataSet[p]} > 1.
  \end{array}
  \labelEquation{dom-cons-input-operands-not-taking-min-value}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{pre-solv-illegal-matches-uncovered-ops}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{pre-solv-illegal-matches-undefined-data}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{pre-solv-illegal-matches-kills}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{pre-solv-illegal-matches-def-locs}
\end{equation}
%
where
%
\begin{equation}
  ...
  \bigcup_{\substack{%
    ...
    \hspace{-2.5em}
    \mStores(m, p).
  \labelEquation{pre-solv-cup-use-locs-of-function}
\end{equation}
%
...
\begin{equation}
  ...
  \labelEquation{pre-solv-illegal-matches-use-locs}
\end{equation}
%
where
%
\begin{equation}
  ...
  \bigcup_{\substack{%
    ...
    \hspace{-2.5em}
    \mStores(m, p).
  \labelEquation{pre-solv-cup-def-locs-of-function}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{pre-solv-redun-kills}
\end{equation}
...
\begin{equation}
  ...
  \labelEquation{pre-solv-redun-non-null-copy-matches}
\end{equation}
%
...
\todo{refined objective function is better (as expected}
...
\todo{could not run experiments for other model refinements because Chuffed does
  not support set variables}
...
\NewDocumentCommand{\insertSolvTechSpeedupPlot}{mm}{%
  \insertSpeedupPlot{%
    \expDir/solv-tech-#1-pre+solving-time-speedup.plot%
  }{#2}
}

\NewDocumentCommand{\mkSolvTechSubfigure}{om}{%
  \subcaptionbox{%
                  \IfBooleanTF{#1}{#1}{\refEquation{#2}}%
...
\begin{figure}
  \centering%
  \insertSolvTechSpeedupPlot{disable-all}{1}
...
\begin{figure}
  ...
  \mkSolvTechSubfigure{impl-cons-place-ops-same-as-entry-blocks}%
  \hfill%
  \mkSolvTechSubfigure{impl-cons-defs-dominate-entry-blocks}

  \mkSolvTechSubfigure{impl-cons-place-phi-ops-same-as-def-edge}
...
\begin{figure}
  ...
  \hfill%
  \mkSolvTechSubfigure{impl-cons-spanning-uses}
...
\begin{figure}
  ...
  \mkSolvTechSubfigure{impl-cons-constrain-use-locs}%
  \hfill%
  \mkSolvTechSubfigure{impl-cons-constrain-def-locs}
...
\begin{figure}
  \centering%
  \mkSolvTechSubfigure{impl-cons-fix-fall-through}
...
\begin{figure}
  ...
  \mkSolvTechSubfigure{dom-cons-loc-of-stats}%
  \hfill%
  \mkSolvTechSubfigure{dom-cons-operands-of-non-selected-matches}

  \mkSolvTechSubfigure{dom-cons-input-operands-not-taking-min-value}%
  \hfill%
...
\begin{figure}
  \centering%
  \mkSolvTechSubfigure[Dominated matches]{pre-solv-dom-matches}
...
\begin{figure}
  ...
  \mkSolvTechSubfigure{pre-solv-illegal-matches-uncovered-ops}%
  \hfill%
  \mkSolvTechSubfigure{pre-solv-illegal-matches-undefined-data}

  \mkSolvTechSubfigure{pre-solv-illegal-matches-kills}%
  \hfill%
  \mkSolvTechSubfigure{pre-solv-illegal-matches-def-locs}

  \mkSolvTechSubfigure{pre-solv-illegal-matches-use-locs}
...
\begin{figure}
  ...
  \mkSolvTechSubfigure{pre-solv-redun-kills}%
  \hfill%
  \mkSolvTechSubfigure{pre-solv-redun-non-null-copy-matches}
...
\begin{figure}
  \centering%
  \mkSolvTechSubfigure[Canonical locations]{pre-solv-canonical-locs}
