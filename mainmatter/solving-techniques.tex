...
\begin{table}
  ...
  \caption[%
          ...
          {%
            ...
            breaking constraint.
            %
            See also \refFigure{dom-cons-vs-no-cons-solving-time-plots}%
          }
...
\begin{table}
  \centering%
  \figureFontSize%
  \begin{tabular}{p{8mm}*{9}{@{\colsep}c@{\colsep}}}
    \toprule
      & \multirow{2}{15mm}{%
          \centering\tabhead dominated matches%
        }
      & \multicolumn{7}{c}{\tabhead equation}
      & \multirow{2}{15mm}{%
          \centering\tabhead canonical locations%
        } \\
    \cmidrule(r){3-9}%
      &
  ...
  \caption[%
          ...
          {%
            ...
            %
            See also \refFigure{presolving-vs-no-pre-solving-time-plots}%
          }
