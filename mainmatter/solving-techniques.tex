...
%
We expect all \glspl{constraint} except
Eqs.\thinspace\refEquation*{impl-cons-defs-in-spanned-blocks} and
\refEquation*{impl-cons-spanned-input} to lead to an overall reduction in
solving time.
%
Hence, in these cases the \gls{geometric mean improvement} should be greater
than~\num{1}.
%
...
claim that Eqs.\thinspace\refEquation*{impl-cons-defs-dominate-defs},
...
and that Eqs.\thinspace\refEquation*{impl-cons-defs-in-spanned-blocks} and
\refEquation*{impl-cons-spanned-input} have no impact on solving time.
%
However, \refEquation{impl-cons-place-phi-ops-same-as-def-edges} appears to have
no impact on solving time, and
...
\refEquation*{impl-cons-locs-of-uses}, and \refEquation*{impl-cons-locs-of-defs}
appear to have a negative impact on solving time.
