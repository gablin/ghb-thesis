...
\begin{figure}
  ...
  \caption[%
            Plot for evaluating the impact on solving time made by different
            configurations of symmetry and dominance breaking constraints%
          ]%
          {%
  ...
  \labelFigure{diff-dom-cons-conf-solving-time-plot}
\end{figure}
...
\RefFigure{diff-dom-cons-conf-solving-time-plot} shows the normalized solving
...
\begin{figure}
  ...
  \caption[%
            Plot for evaluating the impact on solving time made by different
            configurations of presolving techniques%
          ]%
          {%
            Normalized solving times (incl.\ presolving time) for four
  ...
  \labelFigure{diff-presolving-conf-solving-time-plot}
\end{figure}
...
\RefFigure{diff-presolving-conf-solving-time-plot} shows the normalized solving
times (including presolving time) for three \glspl{constraint model}: one with
