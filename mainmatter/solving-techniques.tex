...
As the \gls{GMI} is \printGMI{%
  ...
  \NewOpCostFunVsOldPrePlusSolvingTimeSpeedupPrePlusSolvingTimeRegularSpeedupCiMax%
}, we see that \glsshort{constraint model}~\refModel{obj-fun-div-mul} results in
...
outperforms \glsplshort{constraint model}~\refModel{obj-fun-naive-no-b}
...
\glsshort{constraint model}~\refModel{st-ex-no-techs}.
%
