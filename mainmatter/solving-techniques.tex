...
by five versions of the \gls{constraint model}: two based on the naive
...
{\codeFont debug\_dump\_byte}, and {\codeFont write\_file\_trai}), the loss in
performance for these \glspl{function} is overshadowed by the gain in
