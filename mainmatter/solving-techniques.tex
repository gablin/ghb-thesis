...
\begin{table}
  \centering%
  \figureFontSize%
  \begin{tabular}{p{8mm}*{14}{@{\colsep}c@{\colsep}}}
    \toprule
      & \multicolumn{14}{c}{\tabhead equation} \\
    \cmidrule{2-15}%
  ...
  \caption[%
          ...
          {%
            ...
            %
            See also \refFigure{single-impl-con-vs-no-con-solving-time-plots}%
          }
  \labelTable{single-impl-con-vs-no-con-solving-time-geom-mean-improvements}
\end{table}
%
The \glspl{GMI}, given in
