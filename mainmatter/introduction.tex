...
%
Most importantly, the model is the first to combine the task of \gls{instruction
  selection} with \gls{global code motion} in order to alleviate selection of
sophisticated \glspl{instruction} that would otherwise not have been applicable.
%
