...
\node[gp node center] at (2.999,1.955) {\plotBarValue{0.625112}};
\node[gp node center] at (4.710,1.902) {\plotBarValue{0.229050}};
\node[gp node center] at (6.421,2.090) {\plotBarValue{1.637786}};
\node[gp node center] at (8.132,2.196) {\plotBarValue{2.425374}};
\node[gp node center] at (9.843,2.152) {\plotBarValue{2.101483}};
\node[gp node center] at (11.555,2.040) {\plotBarValue{1.262073}};
\node[gp node center] at (13.266,2.245) {\plotBarValue{2.796017}};
\node[gp node center] at (14.977,2.111) {\plotBarValue{1.795430}};
\node[gp node center] at (16.688,2.067) {\plotBarValue{1.462714}};
\node[gp node center] at (18.399,3.726) {\plotBarValue{13.854515}};
\node[gp node center] at (20.110,2.417) {\plotBarValue{4.076437}};
\node[gp node center] at (21.821,2.609) {\plotBarValue{5.515458}};
\node[gp node center] at (23.532,2.007) {\plotBarValue{1.013928}};
\node[gp node center] at (25.243,2.106) {\plotBarValue{1.755737}};
\node[gp node center] at (26.954,2.072) {\plotBarValue{1.501445}};
\node[gp node center] at (28.666,1.904) {\plotBarValue{0.249549}};
\node[gp node center] at (30.377,2.071) {\plotBarValue{1.494730}};
\node[gp node center] at (32.088,2.012) {\plotBarValue{1.056352}};
\node[gp node center] at (33.799,1.894) {\plotBarValue{0.171116}};
\node[gp node center] at (35.510,8.152) {\plotBarValue{46.911687}};
\draw[gp path] (1.012,8.381)--(1.012,1.687)--(36.945,1.687)--(36.945,8.381)--cycle;
