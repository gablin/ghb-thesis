...
\node[gp node center] at (5.043,5.618) {\plotBarValue{0.110717}};
\node[gp node center] at (6.737,1.963) {\plotBarValueNoSolution};
\node[gp node center] at (8.430,2.164) {\plotBarValue{0.006095}};
\node[gp node center] at (10.124,2.368) {\plotBarValue{0.012263}};
\node[gp node center] at (11.817,2.532) {\plotBarValue{0.017241}};
\node[gp node center] at (13.511,1.963) {\plotBarValueNoSolution};
\node[gp node center] at (15.205,2.194) {\plotBarValue{0.007012}};
\node[gp node center] at (16.898,2.208) {\plotBarValue{0.007437}};
\node[gp node center] at (18.592,2.241) {\plotBarValue{0.008424}};
\node[gp node center] at (20.285,2.020) {\plotBarValue{0.001725}};
\node[gp node center] at (21.979,1.993) {\plotBarValue{0.000908}};
\node[gp node center] at (23.672,4.552) {\plotBarValue{0.078442}};
\node[gp node center] at (25.366,7.927) {\plotBarValue{0.180670}};
\node[gp node center] at (27.060,2.751) {\plotBarValue{0.023877}};
\node[gp node center] at (28.753,1.963) {\plotBarValueNoSolution};
\node[gp node center] at (30.447,2.177) {\plotBarValue{0.006472}};
\node[gp node center] at (32.140,3.851) {\plotBarValue{0.057194}};
\node[gp node center] at (33.834,1.963) {\plotBarValueNoSolution};
\node[gp node center] at (35.527,2.113) {\plotBarValue{0.004532}};
