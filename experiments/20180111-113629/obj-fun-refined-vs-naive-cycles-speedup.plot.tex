...
\gpcolor{color=gp lt color border}
\node[gp node right] at (1.380,3.099) {\plotSpeedupTics{0.05}};
\gpcolor{rgb color={0.753,0.753,0.753}}
\draw[gp path] (1.380,4.420)--(36.945,4.420);
\gpcolor{color=gp lt color border}
\node[gp node right] at (1.380,4.420) {\plotSpeedupTics{0.1}};
\gpcolor{rgb color={0.753,0.753,0.753}}
\draw[gp path] (1.380,5.740)--(36.945,5.740);
\gpcolor{color=gp lt color border}
\node[gp node right] at (1.380,5.740) {\plotSpeedupTics{0.15}};
\gpcolor{rgb color={0.753,0.753,0.753}}
\draw[gp path] (1.380,7.061)--(36.945,7.061);
\gpcolor{color=gp lt color border}
\node[gp node right] at (1.380,7.061) {\plotSpeedupTics{0.2}};
\gpcolor{rgb color={0.753,0.753,0.753}}
...
\node[gp node center] at (5.043,1.963) {\plotBarValueNoBaselineSolution};
...
\node[gp node center] at (15.205,1.963) {\plotBarValueNoBaselineSolution};
...
\node[gp node center] at (21.979,1.963) {\plotBarValueNoBaselineSolution};
\node[gp node center] at (23.672,1.963) {\plotBarValueNoSolution};
\node[gp node center] at (25.366,7.262) {\plotBarValue{0.200660}};
...
\node[gp node center] at (32.140,2.842) {\plotBarValue{0.033270}};
\node[gp node center] at (33.834,1.963) {\plotBarValueNoSolution};
\node[gp node center] at (35.527,2.026) {\plotBarValue{0.002381}};
\draw[gp path] (1.380,8.381)--(1.380,1.779)--(36.945,1.779)--(36.945,8.381)--cycle;
