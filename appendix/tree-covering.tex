...
%
For each line in the \gls{function}, \gls{pattern matching} is done starting at a
...
only supported unary and binary \glspl{pattern} with a maximum height of~1, thus
