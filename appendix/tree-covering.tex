...
\footnote{%
  ...
  all with equally creative naming schemes:
  \gls{Burg}~\cite{FraserEtAl:1992:Burg},
  ...
  \gls{MBurg}~\cite{Gough:1995, GoughLedermann:1997},
  \gls{OCamlBurg}~\cite{OCamlBURG}, and
...
\refAlgorithm{aho-etal-cost-algorithm-2}, lines~8--21.
%
...
of generated \glspl{state}: \gls!{state trimming}, which extends and generalizes
...
formulated each \gls{chromosome} as a binary bit string where a~1 indicates the
selection of a particular \gls{pattern}.
%
