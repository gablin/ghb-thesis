  ...
  \begin{minipage}{66mm}%
    ...
    \caption[Machine grammar example]%
            {%
              ...
              %
              Rules 7--11 do not have a nonterminal on the left-hand side as
              memory store instructions do not produce anything.
              %
...
\refFigure{glanville-graham-machine-grammar}, \glspl{rule}~5 and~6 are two such
\glspl{rule}).
%
...
\refFigure{hoffmann-odonnell-example-subsumption},\!%
%
\footnote{%
  There is also a corresponding \gls{immediate subsumption graph} $\mGImmS$.
  %
...
\refFigure{hoffmann-odonnell-subsumption-algorithm}.
%
