...
\glspl{program} are represented using \gls!{postfix notation} (or
...
\begin{figure}
  ...
  \caption[%
            Example of a program expressed using \citeauthor{Wasilew:1972}'s
            IR%
          ]%
          {%
            Example of a program expressed using \citeauthor{Wasilew:1972}'s
...
$\irAddText$ reg(a) $\irMulText$ reg(b) int(2)
\end{filecontents*}
...
\begin{figure}
  ...
  \subcaptionbox{%
                  ...
                  %
                  The subscripts appearing in the nonterminals are used for
                  book keeping%
