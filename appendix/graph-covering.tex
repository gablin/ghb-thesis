...
not enough for handling all aspects featured in the \glspl{function} and
\glspl{instruction}.
%
...
%
By resorting to full-fledged \glspl{graph} we attain \gls!{graph covering},
which is the most general form of covering.
%
...
\refFigure{sea-of-nodes-example-ssa-graph}, thus giving a complete view of the
...
\section{Pattern Selection on the Click-Paleczny Graph}
