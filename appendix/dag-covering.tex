...
%
\begin{displaymath}
  (\mVar{x}_{1,1} \mOr \mVar{x}_{1,2} \mOr \ldots) \mAnd
  (\mVar{x}_{\,2,1} \mOr \mVar{x}_{\,2,2} \mOr \ldots) \mAnd
  \ldots
\end{displaymath}
%
A variable~$\mVar{x}$ can also be negated, written as \mbox{$\mNot \mVar{x}$}.
...
%
\begin{enumerate}
  \item If a variable~$\mVar{x}$ is set to true ($T$), then the selected
...
%      \centering%
%      \input{figures/dag-covering/undagging-1}
%    \end{minipage}%
%  \end{subfigure}
%  \hfill%
...
%
%      \centering%
%      \input{figures/dag-covering/undagging-2}
%    \end{minipage}%
%  \end{subfigure}
%  \hfill%
...
%
%      \centering%
%      \input{figures/dag-covering/undagging-3}
%    \end{minipage}
%  \end{subfigure}
%
...
%      \begin{minipage}{1cm}%
%        \centering%
%        \input{figures/dag-covering/arnold-example-tree1}%
%      \end{minipage}%
%      \hfill%
%      \begin{minipage}{2cm}%
%        \centering%
%        \input{figures/dag-covering/arnold-example-tree2}%
%      \end{minipage}%
%    \end{minipage}
%  \end{subfigure}
%
...
%    \begin{minipage}{3cm}
%      \centering%
%      \input{figures/dag-covering/mis-example-conflict}%
%    \end{minipage}
%  \end{subfigure}
%
...
%    \begin{minipage}{6cm}%
%      \centering%
%      \input{figures/graph-covering/unate-covering-example-graph}%
%    \end{minipage}%
%  \end{subfigure}
%  \hfill%
