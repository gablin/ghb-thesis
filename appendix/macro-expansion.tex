...
\begin{figure}%
  ...
  \caption[MIML example]%
          {%
            An example on how an arithmetic expression \irCode{A[I] = B + C[J] *
              D} is represented using MIML commands.
            %
            %
            The \irCode{SS} command is used for data referencing and the
            \irCode{ASSG} command assigns a value to a variable.
            %
...
\begin{figure}%
  ...
  \caption[OMML example]%
          {%
            ...
            %
            The \irCode{rclass} command declares a register class, and the
            \irCode{rpath} command declares a permissible transfer between a
...
%design is similar to \citeauthor{Miller:1971}'s in that the \gls{frontend} first
...
%\citeauthor{Miller:1971}'s, but handles more complex data types, addressing
...
%\citeauthor{Miller:1971} and \citeauthor{Snyder1975}, the \glspl{instruction} are
...
%
%Like \citeauthor{Miller:1971}, \citeauthor{Fraser1979} described the semantics of
