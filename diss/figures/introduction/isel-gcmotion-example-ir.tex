...
\begin{tikzpicture}[
  ...
  \node [below=of b1] (b2)
        {%
          \begin{tabular}{@{}l@{}}
            \irTemp{1} \irAssign{} i \irLE{} N\\
            \irJump{} \irTemp{1}, b3, end
          \end{tabular}%
        };
  \node [below=of b2] (b3)
        {%
          \begin{tabular}{@{}ll@{}}
            \multicolumn{2}{@{}l@{}}{\irTemp{2} \irAssign{} i \irMul{} 4}\\
            \irTemp{3} \irAssign{} A \irAdd{} \irTemp{2}
              & \irTemp{4} \irAssign{} B \irAdd{} \irTemp{2}\\
            a \irAssign{} \irLoad{} \irTemp{3}
              & b \irAssign{} \irLoad{} \irTemp{4}\\
            \multicolumn{2}{@{}l@{}}{%
              c \irAssign{} a \irAdd{} b%
            }\\
            \multicolumn{2}{@{}l@{}}{%
              \irTemp{5} \irAssign{} MAX \irLE{} c%
            }\\
            \multicolumn{2}{@{}l@{}}{%
              \irJump{} \irTemp{5}, \irBlock{b4}, \irBlock{b5}%
            }
          \end{tabular}%
        };
