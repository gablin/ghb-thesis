...
%
A \gls{variable}~$\mVar{x}$ is \gls!{assigned.v} if \mbox{$|\mDomain(\mVar{x})|
  = 1$}.
%
...
%
A \gls!{constraint store} is a ...
%
\todo{finish paragraph}
%
\todo{cite \cite{Bessiere:2006}}
%
\todo{cite \cite{SchulteCarlsson:2006}}

\todo{discuss propagation strengths}

\todo{discuss propagators for global constraints}

\todo{compare propagation between distinct and binary decomposition}
