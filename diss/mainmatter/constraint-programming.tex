...
As stated earlier, solving can be improved by extending the \gls{constraint
...
\Gls{dominance breaking.c} is therefore a generalization of \gls{symmetry
  breaking.c}.
%
These \glspl{constraint} are discussed in detail by \textcite{Smith:2006},
\textcite{GentEtAl:2006}, and \textcite{ChuStuckey:2015}, respectively.

\todo{give example of implied constraint}
