...
packing rectangles inside another, larger rectangle.
%
...
force one of the rectangles to be packed into one of the quadrants of the
enclosing rectangle.
...
\Gls{dominance breaking.c} is therefore a generalization of \gls{symmetry
  breaking.c}.
%
\todo{give example of dominance breaking constraint}
