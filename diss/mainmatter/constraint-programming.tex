...
Solving of \glspl{constraint model} involves interleaving of \gls{propagation}
and \gls{search}.
%
...
%
An entity that performs \gls{propagation} and \gls{search} is called a
\gls!{constraint solver} (or just \gls!{solver}).
