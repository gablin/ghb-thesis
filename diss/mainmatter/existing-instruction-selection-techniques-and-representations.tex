...
\begin{figure}
  ...
  \caption[Principle timeline diagram]%
          {%
            Diagram illustrating how research on instruction selection
            (\numTotalPublications~publications in total), with respect to the
            fundamental principles, has progressed over time.
            %
            The bar widths indicate the number of publications --
