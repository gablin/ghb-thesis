...
As expected from their name, \gls!{multi-output.ic} \glspl{instruction} produce
more than one observable output from the same input.
%
...
different input values are referred to as \gls{disjoint-output.ic}
\glspl{instruction}.
%
...
\glspl{block} are referred to as \gls{inter-block.ic}
\glspl{instruction}.
%
