...
\begin{figure}
  ...
  \subcaptionbox{%
                  Function graph in simple, graph-based, IR form%
                  \labelFigure{simple-graph-ir-example-graph}%
                }%
                {%
                  \small%
  ...
  \caption[%
            Example of a function graph represented using the simple graph-based
            IR%
          ]%
          {%
            Example of a function graph represented using the simple graph-based
