...
%
As a complete comparison is superfluous for understanding the rest of the
dissertation, only a brief discussion is given in this chapter for sake of
brevity.
%
For the full discussion, see \refAppendixRange{macro-expansion}{graph-covering}.
