...
%
We say that \mbox{$\mCount(v, \mVar{x}_1, \ldots, \mVar{x}_k, \mVar{y})$} holds
if exactly $\mVar{y}$ \glspl{variable} in the set \mbox{$\mVar{x}_1, \ldots,
  \mVar{x}_k$} are assigned value~$v$ (for a formal definition, see
\refChapter{constraint-programming}, \refDefinition{count}).
%
