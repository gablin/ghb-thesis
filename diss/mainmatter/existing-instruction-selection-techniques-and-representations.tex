...
Several approaches model \gls{instruction selection} using \gls!{IP}, which is a
method for solving combinatorial optimization problems (see \cite{Wolsey:1998}
for an overview).
%
...
matrix.
%
\Gls{IP} is often also referred to as \gls!{ILP}.

\todo{discuss \cite{WilsonEtAl:1994}}
