...
\begin{figure}
  ...
  \hfill%
  \subcaptionbox{%
                  Corresponding \glspl{expression tree}, where the common
                  subexpression has been split%
  ...
  \caption[An example illustrating the limitation of expression trees]%
          {%
            An example illustrating that using block graphs would result in
...
%
If represented as a \gls{block graph} (see
