...
%
We say that \mbox{$\mGCC(v, \mVar{x}_1, \ldots, \mVar{x}_k, \mVar{y})$} holds
...
\refChapter{constraint-programming}, \refDefinition{gcc}).
%
For example, the constraint \mbox{$\mGCC(4, \mVar{x}_1 \in \mSet{4},
