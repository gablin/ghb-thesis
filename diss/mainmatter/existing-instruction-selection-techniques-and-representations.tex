...
processors%
%
\footnote{A \gls!{VLIW} \glsEmph{processor} is a processor that executes
  multiple \glspl{instruction} in parallel, where the schedule has been computed
  by the \gls{compiler} and is part of the assembly code.}
%
...
To solve the problems described in \refSection{motivation}, none of the
