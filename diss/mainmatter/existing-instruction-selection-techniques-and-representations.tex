...
\begin{figure}
  ...
  \caption[Principle timeline diagram]%
          {%
            ...
            %
            With \numTotalPublications~publications in total, the width of the
            bars indicate the number of relative publications for a given year
...
This chapter covers the most well-known applications of \gls{tree covering}.
%
...
in linear time, nearly all \glspl{combinatorial approach} are based on
\glspl{DAG covering} with one exception, which is based on \glspl{graph
  covering}.
%
...
\todo{combinatorial approaches necessitates global instruction selection to be
  viable}
