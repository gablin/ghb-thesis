...
%
The \gls{IR} assumes the \gls{function} to be in \gls!{SSA} form, in which a
\gls{variable} is defined exactly once.
%
...
%
These nodes are connected using data-flow edges, ignoring the fact that the
\glspl{operation} may belong to different \glspl{block}.
%
...
\todo{describe how to model instruction selection using PBQP}

\todo{describe SSA-graphs}
