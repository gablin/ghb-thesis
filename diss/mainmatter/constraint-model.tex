...
elimination of common subexpressions, and the third concerns implicit value
...
beneficial to recompute a values appearing in common subexpression instead of
reusing it.
%
...
%
However, \refEquationRange{operation-coverage}{data-definitions} require that
...
\glspl{solution}.
%
In addition, many of the solving techniques rely on the fact that \todo{finish
  sentence}
