...
\begin{figure}
  ...
  \subcaptionbox{%
                  ...
                  \labelFigure{alt-values-example-uf-graph}%
                }%
                [28mm]%
                {\input{figures/constraint-model/alt-values-example-uf-graph}}%
  \hfill%
  \subcaptionbox{%
                  UF graph after copy extension%
                  \labelFigure{alt-values-example-after-ce}%
                }%
                {\input{figures/constraint-model/alt-values-example-after-ce}}%
  \hfill%
  \subcaptionbox{%
                  Redundant copying of values%
                  \labelFigure{alt-values-example-redundant-copies}%
                }%
                [32mm]%
                {%
                  \input{%
                    figures/constraint-model/%
                    alt-values-example-redundant-copies%
                  }%
                }%
  \hfill%
  \mbox{}
  ...
  \hfill%
  \subcaptionbox{%
                  Matches with alternative values%
                  \labelFigure{alt-values-example-new-matches}%
                }%
                [50mm]%
                {%
                  \input{%
                    figures/constraint-model/alt-values-example-new-matches%
                  }%
                }%
  \hfill%
  \subcaptionbox{%
                  Reuse of copied value%
                  \labelFigure{alt-values-example-value-reuse}%
                }%
                [34mm]%
                {%
                  \input{%
                    figures/constraint-model/alt-values-example-value-reuse%
                  }%
                }%
  \hfill%
  \mbox{}
