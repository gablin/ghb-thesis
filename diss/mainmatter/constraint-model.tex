...
%
With these definitions, the \gls{constraint} can naively be modeled as
%
\begin{equation}
  \begin{array}{c}
...
%
We therefore only use \refEquation{dom} for sake of describing the
...
\begin{equation}
  \begin{array}{c}
    ...
    \forall d \in \mDataSet[p] \hspace{-.8pt},
  \end{array}
...
%
However, this is a naive implementation and we use instead a refined version
introduced in \refChapter{solving-techniques}.
