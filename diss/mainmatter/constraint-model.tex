...
available, where $\mLocationSet$ denotes the set of \glspl{location} provided by
the \gls{target machine} and $\mIntLocation$ denotes a special \gls{location}
for values that cannot be reused across \glspl{instruction}.
%
