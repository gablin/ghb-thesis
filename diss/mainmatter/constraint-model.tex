...
\gls{objective function}, which will be refined in
\refChapter{solving-techniques}.


\subsubsection{Variables}

The \gls{variable} \mbox{$\mVar{cost} \in \mathbb{N}$} models the total cost of
the selected \glspl{match}.
%
...
\refChapter{solving-techniques}, which offers much stronger propagation.
