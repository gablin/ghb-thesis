...
\refTable{contributions-per-publication} shows in which publications each
contribution is manifested.
...
constraint programming to solve register allocation and instruction scheduling).
