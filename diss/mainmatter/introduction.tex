...
%
By \emph{extensible}, it means that approach can be extended to integrate other,
related tasks of \gls{code generation}.
...
%
The graph is subjected to a series of transformations, which are described later
in this dissertation, and then fed to a matcher together with the \gls{pattern
  set} of the specified \gls{target machine}.
%
