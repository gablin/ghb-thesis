...
%
\RefSection{intro-overview} describes the problems addressed by this work, and
\refSection{intro-motivation} gives a motivation for why these problems matter.
%
\RefSection{intro-thesis-statement} presents the thesis statement,
\refSection{intro-approach} discusses the proposed approach, and
\refSection{intro-research-methods} describes the methods applied in this
research.
%
\RefSection{intro-contributions} summarizes the main contributions of the
dissertation, and \refSection{intro-publications} lists the underlying
publications.
%
Lastly, \refSection{intro-outline} outlines the structure of the dissertation.



\section{Overview}
\labelSection{intro-overview}
...
Every quarter, over 100 million microprocessors are shipped in various devices
such as PCs, servers, tablets, and phones~\cite{Intel:2014:NewsRelease}.
%
Each of these processors are built to execute a vast range of \glspl{program},
from tiny \emph{Hello, world!} tests to large-scale Earth simulations.
%
For this task the processor provides a set of \glspl{instruction}, which are
executed one after another.
%
Hence, to run a given \gls{program} on a specific processor, the \gls{program}
must be implemented using the \glspl{instruction} provided by that processor,
resulting in a sequence of \glspl{instruction} called \gls!{assembly code}.

Translating a \gls{program} into \gls{assembly code} can in principle be done by
hand, but for the most part this is done using a \gls{compiler}.
%
...
\subsubsection{Global Instruction Selection and New Representations}
...
\subsubsection{Taking Cost of Data Copying Into Account}
...
\subsubsection{Combining Instruction Selection and Block Ordering}
...
and solved using a combinatorial optimization technique called \gls!{CP}.
%
...
\labelSection{intro-research-methods}
  ...
  \item \labelContribution{survey}
    ...
    \begin{contributions}
      \item \labelContribution{survey-spanning}
        spans over four decades of research,
    \end{contributions}
    from which
    ...
    \end{contributions}
    have been identified, and the approaches are thus
    \begin{contributions}[resume]
      \item \labelContribution{survey-categorization}
...
\begin{table}
  ...
  \begin{tabular}{c@{\qquad}*{13}{c}}
    ...
    \cmidrule(lr){6-11}%
    &
    & \tabhead\refContribution{rep-data-and-control-flow}
...
\begin{publications}
  ...
  \item \labelPublication{cp-paper}
    ...
    %
    \begin{authorshipContribution}
      Hjort~Blindell conceived, designed, and implemented the work, wrote the
      paper, designed the figures, and contributed to data gathering and
      analysis.
      %
      Casta\~neda~Lozano gathered and analyzed the experimental data, and
      contributed to paper writing.
      %
      Carlsson conceived, designed, and implemented most of the solving
      techniques and contributed to paper writing.
      %
      Schulte contributed to paper writing.
    \end{authorshipContribution}
  \item \labelPublication{cases-paper}
    \fullcite{HjortBlindellEtAl:2017:CASES}.
    %
    \begin{authorshipContribution}
      Hjort~Blindell conceived, designed, and implemented the work, gathered and
      analyzed the experimental data, wrote the paper, and designed the figures.
      %
      Carlsson conceived, designed, and implemented most of the solving
      techniques and contributed to paper writing.
      %
      Casta\~neda~Lozano contributed to data gathering and paper writing.
      %
      Schulte contributed to paper writing.
    \end{authorshipContribution}
\end{publications}
...
\begin{publications}[resume]
  ...
  \item \labelPublication{scopes}
    ...
    %
    \begin{authorshipContribution}
      Casta\~neda~Lozano conceived, designed, and implemented the work, wrote
      the paper, and designed the figures.
      %
      Hjort~Blindell contributed to paper writing.
      %
      Carlsson contributed to work implementation and paper writing.
      %
      Drejhammar contributed to work implementation.
      %
      Schulte contributed to paper writing.
    \end{authorshipContribution}
  \item \labelPublication{lctes}
    ...
    %
    \begin{authorshipContribution}
      Casta\~neda~Lozano conceived, designed, and implemented the work, gathered
      and analyzed the experimental data, wrote the paper, and designed the
      figures.
      %
      Carlsson conceived many of the solving techniques and contributed to paper
      writing.
      %
      Hjort~Blindell contributed to data gathering and analysis, and to paper
      writing.
      %
      Schulte contributed to paper writing.
    \end{authorshipContribution}
  \item \labelPublication{cc}
    ...
    \begin{authorshipContribution}
      ...
      writing.
      %
      Hjort~Blindell and Schulte contributed to paper writing.
    \end{authorshipContribution}
  \item \labelPublication{fdl-2016}
    ...
    \begin{authorshipContribution}
      ...
      analyzed the experimental data, wrote the paper, and designed the figures.
      %
      Menne and Sander contributed to paper writing.
    \end{authorshipContribution}
\end{publications}
%
