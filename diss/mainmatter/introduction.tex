...
%
\refSection{overview} describes the problems addressed by this work, and
\refSection{motivation} gives a motivation for why these problems matter.
%
\refSection{thesis-statement} presents the thesis statement,
\refSection{approach} discusses the proposed approach, and
\refSection{research-methods} describes the methods applied in this research.
%
\refSection{contributions} summarizes the main contributions of the
dissertation, and \refSection{publications} lists the underlying publications.
%
Lastly, \refSection{outline} outlines the structure of the dissertation.
...
\labelSection{research-methods}

\todo{write}

\section{Contributions}
\labelSection{contributions}
...
\begin{contributions}
  ...
  \item \labelContribution{experiments}
    ...
    \glspl{program} and yields better code than \glspl{traditional approach};
    and
...
\gls{CP} to solve \gls{register allocation} and \gls{instruction
  scheduling}). \refPublication{fdl-2016} is excluded as it belongs to a
different topic entirely (high-level code generation for graphics processors).

\section{Outline}
\labelSection{outline}
