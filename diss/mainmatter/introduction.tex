...
\begin{inlinelist}[itemjoin={; }, itemjoin*={; and}]
  ...
  \item an \gls!{optimizer}, which performs target-independent optimizations and
    is sometimes called the \gls!{middle-end}
  \item a \gls!{backend}, which performs \gls{code generation}
\end{inlinelist}.
Depending on the target machine, \gls{code generation} in turn typically
