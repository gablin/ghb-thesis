...
architecture. By \emph{practical}, it means that the approach can select
\glspl{instruction} for \glspl{program} of sufficient complexity and scales to
medium-sized \glspl{function}. By \emph{competitive}, it means that the approach
generates code of equal or better quality compared to an existing
state-of-the-art \gls{compiler}. By \emph{extensible}, it means that approach
can be extended to integrate other, related tasks of \gls{code generation}.
