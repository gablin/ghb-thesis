...
\gls{instruction} reduces the execution time by almost \SI{19}{\percent}.

Unfortunately, existing \gls{instruction selection} techniques and
representations do not support selection of such \glspl{instruction}.
%
