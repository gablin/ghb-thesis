...
output. This entails many tasks, as shown in \refFigure{compiler-overview}, such
as syntactic and semantic analysis, a wide range of target-independent
optimizations, and \gls{code generation}. The last task in turn consists of many
subtasks, the most important of which are \gls{instruction selection},
\gls{register allocation}, and \gls{instruction scheduling}.

\paragraph{Instruction Selection}

An \gls{instruction selector} takes a program
