...
\todo{introduce $\mVar{uplace}$ variables}

\todo{introduce dominance relation matrix}
...
\subsection{Refining the Activity Constraint}
...
The naive implementation (\refEquation{naive-objective-function}) of the
\gls{objective function} offers poor \gls{propagation} because it fails to
reason on how cost is distributed across the \glspl{operation} that need to be
covered.
%
\begin{figure}
  \mbox{}%
