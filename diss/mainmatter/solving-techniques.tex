...
\refSection*{st-canonizalized-locations} is based on ideas conceived by
...
\gls{datum}~$d$ to those locations where the users can access $d$ (assuming
there is always at least one \gls{match} making use of $d$).
%
...
\subsection{Canonicalized Locations}
\labelSection{st-canonizalized-locations}
