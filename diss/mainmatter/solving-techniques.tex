...
\begin{equation}
  \begin{array}{c}
    \neg\mVar{sel}[m] \mImp \mVar{alt}[p] = \mMin(\mDataSet[p]), \\
...
can only be defined by \glspl{copy match}, $\mNullMatchSet$ and
$\mKillMatchSet$ denote the set of \glsshort{null match} and \glspl{kill
...
\begin{equation}
  \begin{array}{c}
    ...
    \forall c \in \mInterchDataSet[\mCopy],
    \forall 1 \leq i < k,
    \exists m_i \in \mDefSet(c[i]) \cap \mKillMatchSet.
  \end{array}
