...
\newcommand{\mDataUsedOnceSet}{\mDataSet[+]}
...
\newcommand{\mIntLocation}{l_\textsc{int}}
\newcommand{\mKilledLocation}{l_\textsc{killed}}
\newcommand{\mMemLocation}{l_\textsc{mem}}
\NewDocumentCommand{\mVar}{mo}{
  \mathbf{#1}{\IfValueTF{#2}{[#2]}{}}
}
\newcommand{\mHeuristicCost}{C_{\textsc{heur}}}
...
\DeclareMathOperator{\mDefLocsOf}{\mFunFont{defLocsOf}}
...
\DeclareMathOperator{\mIsInt}{\mFunFont{isInt}}
...
\DeclareMathOperator{\mUseLocsOf}{\mFunFont{useLocsOf}}
\DeclareMathOperator{\mUses}{\mFunFont{uses}}
\DeclareMathOperator{\mValuePrec}{\mConstraintFont{ValPre}}
