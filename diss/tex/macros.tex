...
\newcommand{\irAssign}{$\leftarrow$}
\newcommand{\irAdd}{$+$}
\newcommand{\irBlock}[1]{\irCode{#1}}
\newcommand{\irIf}{{\irFont\bfseries if}}
\newcommand{\irElse}{{\irFont\bfseries else}}
\newcommand{\irJump}{{\irFont\bfseries jump}}
\newcommand{\irLE}{$<$}
\newcommand{\irMul}{$\times$}
\newcommand{\irLoad}{{\irFont\bfseries load}}
\newcommand{\irStore}{{\irFont\bfseries store}}
