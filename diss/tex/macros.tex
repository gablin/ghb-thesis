...
\newcommand{\refTable}[1]{\mbox{Tab.\thinspace\ref{tag:#1}}}
...
\renewcommand*{\chapnumfont}{%
  \normalfont\fontsize{60}{80}\selectfont%
}
...
\newlength{\chapnumkerning}
\setlength{\chapnumkerning}{-6pt}
