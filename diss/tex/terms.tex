...
\newterm[dominate.b]{dominate}[parent={block}]
...
\newterm{alternative value}
\newterm{block extension}
...
\newterm{dual-target branch pattern}
\newterm{internal value}[user1={internal}]
\newterm{kill match}[plural={kill matches}]
\newterm{kill pattern}
\newterm{match duplication}
\newterm{null-copy pattern}
\newterm{null match}[plural={null matches}]
