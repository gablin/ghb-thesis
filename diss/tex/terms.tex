...
\newterm{propagator}
\newterm[bound-consistent.p]{bound-consistent}[parent={propagator}]
\newterm[decreasing.p]{decreasing}[parent={propagator}]
\newterm[domain-consistent.p]{domain-consistent}[parent={propagator}]
\newterm[monotonic.p]{monotonic}[parent={propagator}]
\newterm[value-consistent.p]{value-consistent}[parent={propagator}]
\newterm{search}
\newterm{search space}
\newterm{solution}
