...
\newTerm{constraint propagation}[see=[\seename]{propagation}]
...
\newTerm{presolving}
\newTerm{propagation}[see=[\seename]{constraint propagation}, user1={propagat}]
...
\newTerm{postfix notation}[see=[\seename]{reverse.pn}]
