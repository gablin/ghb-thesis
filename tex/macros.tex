...
\newcommand{\mFunFont}[1]{\textrm{\textit{#1}}}
...
\newcommand{\mVFTwoAttrCmp}{\backsimeq}
...
\setboolean{consFontForceTextRM}{true}
\newcommand{\mConstraintFont}[1]{%
  \ifthenelse{\boolean{consFontForceTextRM}}{%
    \mathsc{\MakeLowercase{#1}}%
  }{%
...
\DeclareMathOperator{\mAllDifferent}{\mConstraintFont{AllDifferent}}
...
\DeclareMathOperator{\mCumulative}{\mConstraintFont{Cumulative}}
...
\DeclareMathOperator{\mIncreasing}{\mConstraintFont{increasing}}
\DeclareMathOperator{\mLat}{\mFunFont{lat}}
\DeclareMathOperator{\mNoOverlap}{\mConstraintFont{NoOverlap}}
...
\newcommand{\expDir}{experiments/20171218-201337}
...
\NewDocumentCommand{\printSolvingTime}{m}{%
  \SI[round-mode=figures, round-precision=3]{#1}{\s}%
}

\NewDocumentCommand{\printMinSolvingTime}{m}{%
  \minOf{#1}%
  \printSolvingTime{\pgfmathresult}%
}

\NewDocumentCommand{\printMaxSolvingTime}{m}{%
  \maxOf{#1}%
  \printSolvingTime{\pgfmathresult}%
}

\NewDocumentCommand{\printCycles}{m}{%
  \num[round-precision=0]{#1}~cycles%
}

\NewDocumentCommand{\printMinCycles}{m}{%
  \minOf{#1}%
  \printCycles{\pgfmathresult}%
}

\NewDocumentCommand{\printMaxCycles}{m}{%
  \maxOf{#1}%
  \printCycles{\pgfmathresult}%
}

\NewDocumentCommand{\printGMI}{m}{%
  \num[round-mode=figures, round-precision=3]{#1}%
}

\NewDocumentCommand{\printGMICI}{mm}{%
  \mbox{$[\printGMI{#1}, \printGMI{#2}]$}%
}
