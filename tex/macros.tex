...
\newcommand{\codeInText}[1]{{\codeFont\relsize{-.5}#1}}
\lstset{basicstyle=\codeFont\footnotesize}
\newcommand{\cCode}[1]{\mbox{\codeFont#1}}
\NewDocumentCommand{\cVar}{mo}{%
  \cCode{#1\IfValueTF{#2}{$_{\text{#2}}$}{}}%
}
\NewDocumentCommand{\cVarInText}{mo}{%
  \codeInText{#1\IfValueTF{#2}{$_{\text{#2}}$}{}}%
}
