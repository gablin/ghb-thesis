...
\NewDocumentCommand{\newTermWithAcronym}{ommO{}}{%
  \IfValueTF{#1}{%
    \newTerm[#1]{#2}[description={#3}, first={#3 (#2)}, #4]%
  }{%
    \newTerm{#2}[description={#3}, first={#3 (#2)}, #4]%
  }%
}
\NewDocumentCommand{\newAcronym}{ommO{}}{%
  \IfValueTF{#1}{%
    \newacronym[sort={#2}, indextext={#2}, #4]{#1}{#2}{#3}%
  }{%
    \newacronym[sort={#2}, indextext={#2}, #4]{#2}{#2}{#3}%
  }%
}
\NewDocumentCommand{\newToolTerm}{omO{}}{%
  \IfValueTF{#1}{%
...
\NewDocumentCommand{\irBr}{ms}{%
  \mbox{%
    {%
      \bfseries%
      \IfBooleanTF{#1}{\irCode*{\irBrText}}{\irCode{\irBrText}}%
    }
...
\NewDocumentCommand{\irCall}{sm}{%
  \mbox{%
    {%
      \bfseries%
      \IfBooleanTF{#1}{\irCode*{\irCallText}}{\irCode{\irCallText}}%
    }
    \IfBooleanTF{#1}{\irCode*{#2}}{\irCode{#2}}%
  }%
}
...
\NewDocumentCommand{\irCondBr}{smmm}{%
  \mbox{%
    {%
      \bfseries%
      \IfBooleanTF{#1}{\irCode*{\irCondBrText}}{\irCode{\irCondBrText}}%
    }
    \IfBooleanTF{#1}{%
